...
namespace Nemiro.OAuth.LoginForms
{
  ...
  public class FoursquareLogin : Login
  {
    ...
    public FoursquareLogin(string clientId, string clientSecret, string returnUrl, string scope) : this(new FoursquareClient(clientId, clientSecret) { ReturnUrl = returnUrl, Scope = scope }) { }
